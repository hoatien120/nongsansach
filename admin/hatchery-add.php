...
if(isset($_POST['form1'])) {
    ...
    $statement = $pdo->prepare("insert into tbl_hatchery (tengiong,magiong,qrcode,hinhanh,xuatxu,gia,mota,huongdansudung) values (?,?,?,?,?,?,?,?)");
    if($statement->execute(array($_POST['tengiong'],$_POST['magiong'],$qrcode_name,$_POST['p_featured_photo'],$_POST['xuatxu'],$_POST['gia'],$_POST['mota'],$_POST['huongdansudung']))){
