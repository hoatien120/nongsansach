...
if(isset($_POST['form1'])){
    ...
    //Thêm feature nào thì nhớ add vô cái update
        $statement = $pdo->prepare("UPDATE tbl_hatchery SET tengiong=?, magiong=?, hinhanh=?, xuatxu=?, gia=? ,mota=?, huongdansudung=?  WHERE id=?");
        if($statement->execute(array($_POST['tengiong'],$_POST['magiong'],$_POST['p_featured_photo'],$_POST['xuatxu'],$_POST['gia'],$_POST['mota'],$_POST['huongdansudung'],$_REQUEST['id']))){
            echo '<script>
			...
			<form class="form-horizontal" action="" method="post" enctype="multipart/form-data">
				...
				<div class="box box-info">
					<div class="box-body">
						...
						<div class="form-group">
							<label for="" class="col-sm-3 control-label">Cập nhật hình ảnh <span>*</span></label>
